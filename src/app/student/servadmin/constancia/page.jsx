    ...
    <main className='flex flex-col  h-full overflow-hidden gap-5'>
      ...
      <Modal modalNumber={1}>
        <div className='bg-white rounded-lg py-5 gap-10 w-1/3'>
          <h2 className='flex flex-col w-full bg-gradient-to-tr from-[#1f5186] to-[#131a2d] text-white text-center'><p>¿Seguro que deseas solicitar tu constancia de estudios?</p></h2>
