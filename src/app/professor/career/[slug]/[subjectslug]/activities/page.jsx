...
export default async function Activities ({ params, searchParams, selectedActivity, setSelectedActivity }) {
  ...
  return (
    <main className='flex flex-col gap-5'>
      ...
      <GetActivities activities={activities} params={params} searchParams={searchParams} selectedActivity={selectedActivity} setSelectedActivity={setSelectedActivity} />
    </main>
  )
}
